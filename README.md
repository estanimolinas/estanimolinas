...
**AI Product Manager — Project Copilot LLC** (may. 2026–actualidad, US, remoto)  
Sprint kickoffs, backlog prioritization, facilitación Scrum. Uso de Claude + MCP de Atlassian (Rovo) contra el repo de GitHub para auditar sprints y redactar epics y user stories.

**B2G Consultant — ASSAL** (oct. 2025–jul. 2026, Ministerio de Salud de Santa Fe)  
Lideré desde cero la digitalización del curso de Certificación en Manipulación de Alimentos (+1.000 usuarios en Moodle) y el roadmap de 15 videos educativos (HeyGen).

**AI-Driven Operations Manager — Zagged** (mar.–may. 2026, NYC, remoto)  
Gestión de 35+ campañas internacionales concurrentes, -30% en tiempo de entrega. Notion Agents y un Claude Skill.md para reporting automatizado.

**Junior SEO Analyst — Refindable** (ene.–sept. 2025, US, remoto)  
Gestión de SEO performance y contenido para clientes de USA y Australia. Armé la integración Google Search Console → Looker Studio para reporting de KPIs. QA tester de un LLM preentrenado para redacción de artículos SEO.

**AI Product Manager Trainee — Project Copilot** (abr. 2024–ene. 2025, Santa Fe, remoto)  
Participé en el ciclo completo de producto (discovery → delivery) con el CTO y el PM, aplicando Scrum y Kanban. Documenté SOPs para estandarizar workflows del equipo.

## Educación

- Especialización y Maestría en Minería de Datos — UTN Regional Santa Fe (2026–2029, en curso)
- Licenciatura en Relaciones Internacionales — UCSF (2022–2026), promedio 9.31. Tesis (10): *"El Desarrollo de la Inteligencia Artificial en el Ciberespacio: La Relación Bilateral de los Estados Unidos y China entre 2017-2025"*
- Intercambio en Global Law and Transnational Studies — Università degli Studi di Torino (2023–2024)
- Track de Negocios / AI Agency — Golem Lab AI (2026, en curso)
- Empower Digital Product Leaders™ — ITtude, mentoría intensiva de Product Management (abr.–jul. 2026)
...
- **[data-analysis-portfolio](https://github.com/estanimolinas/data-analysis-portfolio)** — Portfolio de análisis de datos (Excel, Python, SQL).
- **[ResearcherBasicAIAgent](https://github.com/estanimolinas/ResearcherBasicAIAgent)** — Agente de investigación básico con Python y LangChain.
